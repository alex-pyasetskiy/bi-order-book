...
from app.engine import process_order_book_updates  # Import the combined function
import logging
...
async def order_book_stream(
    ...
    try:
        while True:
            ...
            try:
                # Use process_order_book_updates directly
                ...
                async for update in task:  # Iterate through updates from the task
                ...
                connection_manager.disconnect(client_id) # Disconnect after the loop finishes or an error occurs.
